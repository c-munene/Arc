...
WORK=$ROOT/tmp/wsl_arc_gateway_tls_status_c512_long
...
CERT="/mnt/c/Users/Shuakami_Projects/CommunityProject/Arc/tmp/wsl_arc_gateway_tls_status_c512_long/cert.pem"
KEY="/mnt/c/Users/Shuakami_Projects/CommunityProject/Arc/tmp/wsl_arc_gateway_tls_status_c512_long/key.pem"

cat > "$WORK/backend_nginx.conf" <<'NGINX'
worker_processes auto;
pid /mnt/c/Users/Shuakami_Projects/CommunityProject/Arc/tmp/wsl_arc_gateway_tls_status_c512_long/backend.pid;
events { worker_connections 8192; use epoll; }
http {
  access_log off;
  error_log /mnt/c/Users/Shuakami_Projects/CommunityProject/Arc/tmp/wsl_arc_gateway_tls_status_c512_long/backend_error.log warn;
  server {
...
wrk -t8 -c512 -d30s --latency -s "$ROOT/tmp/wrk_status.lua" https://127.0.0.1:18443/x | tee "$WORK/arc_tls_status_30s.txt"
