...
WORK="$ROOT/tmp/wsl_ultra_compare_fast_http1"
...
pid /mnt/c/Users/Shuakami_Projects/CommunityProject/Arc/tmp/wsl_ultra_compare_fast_http1/backend.pid;
events {
...
http {
    access_log off;
    error_log /mnt/c/Users/Shuakami_Projects/CommunityProject/Arc/tmp/wsl_ultra_compare_fast_http1/backend_nginx_error.log warn;
    server {
...
worker_processes auto;
pid /mnt/c/Users/Shuakami_Projects/CommunityProject/Arc/tmp/wsl_ultra_compare_fast_http1/proxy.pid;
events {
    worker_connections 8192;
    use epoll;
}
http {
    access_log off;
    error_log /mnt/c/Users/Shuakami_Projects/CommunityProject/Arc/tmp/wsl_ultra_compare_fast_http1/proxy_nginx_error.log warn;
...
work = Path('/mnt/c/Users/Shuakami_Projects/CommunityProject/Arc/tmp/wsl_ultra_compare_fast_http1')
...
summary['compare'] = {
    ...
    'ultra_vs_backend_rps_ratio': summary['ultra']['avg']['rps'] / b if b else 0.0,
}
...
summary['latency_added_ms'] = {
    ...
    'ultra': summary['ultra']['avg']['lat_avg_ms'] - lat_b,
}
