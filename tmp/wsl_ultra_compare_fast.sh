...
WORK="$ROOT/tmp/wsl_ultra_compare_fast"
...
pid /mnt/c/Users/Shuakami_Projects/CommunityProject/Arc/tmp/wsl_ultra_compare_fast/backend.pid;
events {
...
http {
    access_log off;
    error_log /mnt/c/Users/Shuakami_Projects/CommunityProject/Arc/tmp/wsl_ultra_compare_fast/backend_nginx_error.log warn;
    server {
...
worker_processes auto;
pid /mnt/c/Users/Shuakami_Projects/CommunityProject/Arc/tmp/wsl_ultra_compare_fast/proxy.pid;
events {
    worker_connections 8192;
    use epoll;
}
http {
    access_log off;
    error_log /mnt/c/Users/Shuakami_Projects/CommunityProject/Arc/tmp/wsl_ultra_compare_fast/proxy_nginx_error.log warn;
...
work = Path('/mnt/c/Users/Shuakami_Projects/CommunityProject/Arc/tmp/wsl_ultra_compare_fast')
