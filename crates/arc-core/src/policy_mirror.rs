//! Traffic mirroring policy (config + validation).
//!
//! This module defines **configuration schema** for Mirror and performs strong validation.
//! Runtime execution is implemented in the data plane (see `arc-gateway` mirror dispatcher).
//!
//! # Spec mapping
//!
//! Simple (one-liner):
