...
pub enum TimeoutTierConfig {
    ...
    Scalar(#[serde(with = "humantime_serde")] #[schemars(with = "String")] Duration),
...
fn apply_timeout_config(mut base: EffectiveTimeoutTier, cfg: &TimeoutTierConfig) -> EffectiveTimeoutTier {
    match cfg {
